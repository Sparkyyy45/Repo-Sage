    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-24 md:py-32">
        <motion.div
          ...
          className="relative mx-auto flex max-w-3xl flex-col items-center rounded-2xl border border-border/50 bg-white/60 backdrop-blur-sm p-10 text-center shadow-xl shadow-blue-500/5 md:p-16"
        >
          ...
          <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200/50 bg-blue-50/60 px-4 py-1.5 text-xs text-blue-700 backdrop-blur-sm shadow-sm">
